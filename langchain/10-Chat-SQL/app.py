...
st.title("🦜 LangChain: Chat with any SQL DB using Deepseek R1")
# Add README link
...
if radio_opt.index(selected_opt) == 1:
    ...
    with st.expander("PostgreSQL Connection Details & Sample Questions", expanded=True):
        st.info("""Please provide the PostgreSQL connection details. By default, this app has read-only access to my own Supabase Postgres.
